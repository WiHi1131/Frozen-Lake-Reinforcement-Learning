...
class QLearningAgent:
    def __init__(self, env, learning_rate=0.7, discount_factor=0.95, exploration_rate=1.0, max_exploration_rate=1.0, min_exploration_rate=0.01, exploration_decay_rate=0.005):
        self.env = env
